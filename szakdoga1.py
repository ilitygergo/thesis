...
from function import minimize
from function import imreadgray
from function import notendpoint
from function import flip
from function import connected
from function import equalmatrix
from function import makeequalmatrix

print(bcolors.HEADER, 'Dyer Rosenfeld algoritmus:', bcolors.ENDC)

# Beolvasás szürkeárnyalatos képként
img = imreadgray('pictures/sima.png')
img2 = imreadgray('pictures/sima.png')
